...
import { useCarOwnerStep3 } from "../../hooks/carOwner/useCarOwnerStep3";

export default function CarOwnerStep3() {
  const { form, onSubmit, isLoading, goBack } = useCarOwnerStep3();
