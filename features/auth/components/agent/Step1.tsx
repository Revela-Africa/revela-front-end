...
import { useAgentStep1 } from "../../hooks/agents/useAgentStep1";


export default function AgentStep1() {
  const { form, onNext } = useAgentStep1();
  const { register, formState: { errors } } = form;

  return (
    <div className="font-cabinet">
      <div className="mb-10">
        <h1 className="text-2xl font-extrabold text-[#D4900A]">Personal Details</h1>
